...
function login() {
    ...
    aktuellerBenutzer = benutzer.find(benutzer => benutzer.benutzername === benutzername && benutzer.pin === pin);
...
`);
        ...
        console.log(chalk.red('❌ Ungültiger Benutzername oder PIN. Bitte versuchen Sie es erneut.'));
        login();
    }
}
...
function geldEinzahlen() {
    const betragEingabe = readlineSync.question('Betrag zum Einzahlen eingeben: $');
    ...
    if (isNaN(betrag)) {
        console.log(chalk.red('❌ Ungültige Eingabe. Bitte geben Sie eine gültige Zahl oder "exit" ein.'));
        hauptmenü();
        return;
    }
    ...
    aktuellerBenutzer.transaktionen.push({ typ: 'Einzahlung', betrag, datum: new Date() });
    console.log(chalk.green('√ Einzahlung erfolgreich.'));
    hauptmenü();
}

function geldAbheben() {
    const betragStr = readlineSync.question('Geben Sie den abzuhebenden Betrag ein: $');
    ...
    if (betrag > aktuellerBenutzer.guthaben) {
        ...
        aktuellerBenutzer.guthaben -= betrag;
        aktuellerBenutzer.transaktionen.push({ typ: 'Abhebung', betrag, datum: new Date() });
...
function geldÜberweisen() {
    ...
    const empfängerBenutzername = readlineSync.question('Geben Sie den Benutzernamen des Empfängers ein: ');
    ...
    const empfänger = users.find(benutzer => benutzer.benutzername === empfängerBenutzername);
    ...
    const zweck = readlineSync.question('Geben Sie den Zweck der Überweisung ein: ');
    const betragStr = readlineSync.question('Geben Sie den zu überweisenden Betrag ein: $');
    ...
    setTimeout(() => {
        ...
        const formular = [`Geld Überweisen:`, 
...
function  transaktionshistorieAnzeigen() {
    ...
    aktuellerBenutzer.transaktionen.forEach(transaktion => {
        console.log(`${transaktion.datum} - ${transaktion.typ}: $${transaktion.betrag}`);
